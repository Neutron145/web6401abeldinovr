...
function fibonacci(n) {
	let current_fibonacci = 1;
	let prev_fibonacci = 0;
	for (let i = 2; i <= n; i++) {
		let temp_fibonacci = current_fibonacci + prev_fibonacci;
		prev_fibonacci = current_fibonacci;
		current_fibonacci = temp_fibonacci;
	}
...
function getOperationFn(initialValue, operatorFn) {
	if (operatorFn === undefined || operatorFn == null) {
		...
		return result => { initialValue = operatorFn(initialValue, result);
			return initialValue; }; 
	}
}
